...
#
# Ejemplo:
#   ./devops/deploy.sh ~/.ssh/lernymart-prod.pem ubuntu@54.123.45.67
# =============================================================================
...
if [[ $# -lt 2 ]]; then
  ...
  echo "Ejemplo: $0 ~/.ssh/lernymart-prod.pem ubuntu@54.123.45.67"
  exit 1
fi
...
REMOTE_DEST="/opt/lernymart/backend.jar"
SERVICE_NAME="lernymart.service"
